...
public class NonStaticGlobalVariableEx2 {
	...
	//non static global  variables
		...
		public static void main(String[] args) {
			...
			NonStaticGlobalVariableEx2 ref; // object declaration
			ref = new NonStaticGlobalVariableEx2();// object initilization
					//or
			NonStaticGlobalVariableEx2 ref1 =new NonStaticGlobalVariableEx2();
